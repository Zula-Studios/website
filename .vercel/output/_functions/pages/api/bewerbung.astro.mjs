import { g as getSmtpConfig, r as responseWhenSmtpNotConfigured, s as sendSmtpMail, a as applicationConfirmationHtml } from '../../_astro/smtp-mail-D-Js1Kax.js';
import { g as getStelleLabel } from '../../_astro/careers-De4PpmQH.js';
export { renderers } from '../../renderers.mjs';

const prerender = false;
const TO_EMAIL = "sahbazoglu@tecpert.com";
const MAX_CV_BYTES = 4 * 1024 * 1024;
const ALLOWED_STELLE = /* @__PURE__ */ new Set([
  "shopify-entwickler",
  "individuelle-entwicklung",
  "initiativ"
]);
const ALLOWED_CV_MIME = /* @__PURE__ */ new Set([
  "application/pdf",
  "application/msword",
  ...
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; color: #0C0C0F;">
      ...
      <div style="background: white; padding: 20px 32px; border: 1px solid #EBEBEF; border-top: none; border-radius: 0 0 12px 12px;">
        <p style="margin: 0; font-size: 11px; color: #AEAEB5;">Eingegangen: ${(/* @__PURE__ */ new Date()).toLocaleString("de-DE", { timeZone: "Europe/Berlin" })} Uhr · Bewerbungsformular</p>
      </div>
    </div>
  `;
